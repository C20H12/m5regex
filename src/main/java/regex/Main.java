...
public class Main {
    ...
    // TOkDO: Modify this code to check if the given string is non-empty, contains at least
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        final boolean propertyOne = Pattern.matches("^(?=.*?[a-z])(?=.*?[A-Z])(?=.*?\\d).{%d,}$".formatted(minLength), str);
        // as needed, modify this code.
        return propertyOne;
    }

    // Method 2 for checking if a string conforms to a regex: using Matcher.find
    // TkODO: Modify this method to return a list of all email addresses contained in the
    ...
    public static List<String> extractEmails(String str) {
        ...
        final Pattern pattern = Pattern.compile("\\b\\S+?@(mail\\.utoronto\\.ca|utoronto\\.ca)");
    ...
    // TODmO: Modify this method to check whether or not the string contains the same capital letter
